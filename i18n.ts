...
const ko = createTranslation({
	...
	"menu.sendSelection": "선택한 “{selection}”을 Dinox로 보내기",
	...
	"notice.syncNoId": "Dinox: 동기화할 수 없습니다. 프론트매터에 noteId 또는 source_app_id가 없습니다.",
	...
	"settings.ignoreKey.desc": "프론트매터에서 해당 키가 true이면 업데이트를 건너뜁니다.",
	...
	"settings.template.desc": "동기화 요청 시 Dinox API에 전달되는 템플릿입니다.",
	"settings.autoSync.name": "자동 동기화 활성화",
	"settings.autoSync.desc": "Obsidian이 열려 있는 동안 30분마다 자동으로 동기화합니다.",
	...
	"settings.hotkeys.syncCurrent.desc": "현재 노트를 Dinox로 보냅니다. 예: Mod+Shift+K.",
	"settings.hotkeys.create.name": "Dinox 노트 생성 명령",
	"settings.hotkeys.create.desc": "noteId가 없을 때 Dinox에 노트를 생성합니다. 예: Mod+Shift+C.",
...
export function getCurrentLocale(app: App): LocaleCode {
	const configLocale = (app.vault as any)?.getConfig?.("locale") as
		| string
		| undefined;
	const momentLocale =
