...
const en = {
	...
	"notice.templateInvalidAbort": "Dinox: Sync aborted — your template has a syntax error: {error}",
	...
	"settings.section.syncScope": "Sync scope",
	"settings.syncScope.enable.name": "Only sync selected card boxes",
	"settings.syncScope.enable.desc": "When on, only notes in the selected card boxes (and their sub-boxes) are pulled.",
	"settings.syncScope.refresh": "Refresh box list",
	"settings.syncScope.loading": "Loading card boxes…",
	"settings.syncScope.empty": "No card boxes found.",
	"settings.syncScope.loadFailed": "Failed to load card boxes: {error}",
	"settings.syncScope.tokenRequired": "Set your Dinox token first to load card boxes.",
	"settings.syncScope.selectedCount": "{count} selected",
...
const zhCN = createTranslation({
	...
	"notice.templateInvalidAbort": "Dinox：已中止同步——模板存在语法错误：{error}",
	...
	"settings.section.syncScope": "同步范围",
	"settings.syncScope.enable.name": "只同步选中的卡片盒",
	"settings.syncScope.enable.desc": "开启后只拉取选中卡片盒（及其子盒子）的笔记。",
	"settings.syncScope.refresh": "刷新卡片盒列表",
	"settings.syncScope.loading": "正在加载卡片盒…",
	"settings.syncScope.empty": "未找到卡片盒。",
	"settings.syncScope.loadFailed": "加载卡片盒失败：{error}",
	"settings.syncScope.tokenRequired": "请先在设置中填写 Token 再加载卡片盒。",
	"settings.syncScope.selectedCount": "已选 {count} 个",
...
const zhTW = createTranslation({
	...
	"notice.templateInvalidAbort": "Dinox：已中止同步——範本存在語法錯誤：{error}",
	...
	"settings.section.syncScope": "同步範圍",
	"settings.syncScope.enable.name": "只同步選取的卡片盒",
	"settings.syncScope.enable.desc": "開啟後只拉取選取卡片盒（及其子盒子）的筆記。",
	"settings.syncScope.refresh": "重新整理卡片盒清單",
	"settings.syncScope.loading": "正在載入卡片盒…",
	"settings.syncScope.empty": "找不到卡片盒。",
	"settings.syncScope.loadFailed": "載入卡片盒失敗：{error}",
	"settings.syncScope.tokenRequired": "請先在設定中填寫 Token 再載入卡片盒。",
	"settings.syncScope.selectedCount": "已選 {count} 個",
...
const ja = createTranslation({
	...
	"notice.templateInvalidAbort": "Dinox：同期を中止しました — テンプレートに構文エラーがあります：{error}",
	...
	"settings.section.syncScope": "同期範囲",
	"settings.syncScope.enable.name": "選択したカードボックスのみ同期",
	"settings.syncScope.enable.desc": "オンにすると、選択したカードボックス（およびそのサブボックス）のノートのみ取得します。",
	"settings.syncScope.refresh": "ボックス一覧を更新",
	"settings.syncScope.loading": "カードボックスを読み込み中…",
	"settings.syncScope.empty": "カードボックスが見つかりません。",
	"settings.syncScope.loadFailed": "カードボックスの読み込みに失敗しました：{error}",
	"settings.syncScope.tokenRequired": "先にDinoxトークンを設定してください。",
	"settings.syncScope.selectedCount": "{count}件選択中",
	"settings.section.dailyNotes": "Daily notes",
	"settings.dailyNotes.enable.name": "Enable daily note integration",
	"settings.dailyNotes.enable.desc": "Append synced Dinox notes into the core Daily Notes page.",
	"settings.dailyNotes.heading.name": "Section heading",
...
const ko = createTranslation({
	...
	"notice.templateInvalidAbort": "Dinox: 동기화를 중단했습니다 — 템플릿에 구문 오류가 있습니다: {error}",
	...
	"settings.section.syncScope": "동기화 범위",
	"settings.syncScope.enable.name": "선택한 카드박스만 동기화",
	"settings.syncScope.enable.desc": "켜면 선택한 카드박스(및 하위 박스)의 노트만 가져옵니다.",
	"settings.syncScope.refresh": "박스 목록 새로고침",
	"settings.syncScope.loading": "카드박스 불러오는 중…",
	"settings.syncScope.empty": "카드박스를 찾을 수 없습니다.",
	"settings.syncScope.loadFailed": "카드박스 불러오기 실패: {error}",
	"settings.syncScope.tokenRequired": "먼저 Dinox 토큰을 설정하세요.",
	"settings.syncScope.selectedCount": "{count}개 선택됨",
